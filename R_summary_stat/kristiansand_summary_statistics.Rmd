...
# if Neverhegg? set to "Neverhegg"
df$norwegian_name[df$norwegian_name == "Neverhegg?"] <- "Neverhegg"
# if Lind spp set to Lind
df$norwegian_name[df$norwegian_name == "Lind ssp"] <- "Lind"
...
```{r "TREE ATTRIBUTES", echo=FALSE, results='hide',message=FALSE, warning=FALSE, fig.height=3, fig.width = 14}
...
```{r "KARBON LAGRING", echo=FALSE, results='hide',message=FALSE, warning=FALSE, fig.height=3, fig.width = 14}
...
```{r "KARBON BINDING", echo=FALSE, results='hide',message=FALSE, warning=FALSE, fig.height=3, fig.width = 14}
...
```{r CARBON AVOIDED, echo=FALSE, results='hide',message=FALSE, warning=FALSE, fig.height=4, fig.width = 14}
...
<font size="0.8" face="Arial">\*Treslag med CO2-utslipp unngått \< `r params_bar$mean_threshold` kg/år vises ikke i plottet. </font>

```{r OVERFLATEAVRENNING, echo=FALSE, results='hide',message=FALSE, warning=FALSE, fig.height=4, fig.width = 14}
...
```{r POLLUTION, echo=FALSE, results='hide',message=FALSE, warning=FALSE, fig.height=4, fig.width = 14}
